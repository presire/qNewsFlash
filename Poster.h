...
private:
    ...
    [[maybe_unused]] QByteArray  encodeStringToShiftJIS(const QString &str);    // 文字列をShift-JISにエンコードする
    [[maybe_unused]] QString     urlEncode(const QByteArray& byteArray);               // エンコードされたバイト列をURLエンコードする
